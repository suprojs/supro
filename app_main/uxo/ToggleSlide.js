 ...
 */
Ext.define('Ext.uxo.ToggleSlide', {
    extend: 'Ext.Component',
    alias: 'widget.toggleslide',
    
    requires: ['Ext.uxo.Thumb', 'Ext.fx.Anim'],
    ...
    onRender: function()
    {
        ...
        {
            Ext.uxo.ToggleSlide.superclass.disable.call(me);
        }
    },
    ...
    enable: function()
    {
        if(this.disabled)
        {
            Ext.uxo.ToggleSlide.superclass.enable.call(this);
    ...
    disable: function()
    {
        if(!this.disabled)
        {
            Ext.uxo.ToggleSlide.superclass.disable.call(this);
