...
'Нужно проверить конфигурацию и состав программы.'
    ,errload_config_read:
'Ошибка при открытии файла конфигурации! Смотреть в "log".\n' +
'(Возможно не стартанул Node.JS и/или MongoDB)'
    ,errload_config_parse:
'Ошибка при чтении содержимого конфигурационного файла'
    ,errload_fast_config_nwjs:
'[FAST LOAD] опции конфигурации `load` || `loadMiniInit` не работают в `nw.js`'
